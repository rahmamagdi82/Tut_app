...
class _$_LoginObject implements _LoginObject {
  _$_LoginObject(this.name, this.password);
...
abstract class _LoginObject implements LoginObject {
  factory _LoginObject(final String name, final String password) =
      _$_LoginObject;
...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.name, this.countryMobileCode, this.mobilePhone,
  ...
  @override
  String toString() {
    return 'RegisterObject(name: $name, countryMobileCode: $countryMobileCode, mobilePhone: $mobilePhone, email: $email, password: $password, profilePicture: $profilePicture)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, countryMobileCode,
      mobilePhone, email, password, profilePicture);
