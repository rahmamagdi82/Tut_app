...
class _SettingsPageState extends State<SettingsPage> {
        ...
        ListTile(
          ...
          title: Text(
            ...
            style: Theme.of(context)
                .textTheme
                .labelLarge
                ?.copyWith(color: ColorManager.grey1, fontSize: AppSize.s16),
          ),
  ...
  _changeLanguage() {
    if (_appPrefs.getData(key: PREFS_KEY_LANG) ==
        LanguageType.ARABIC.getValue()) {
      _appPrefs.putData(
          key: PREFS_KEY_LANG, value: LanguageType.ENGLISH.getValue());
      Phoenix.rebirth(context);
    } else {
      _appPrefs.putData(
          key: PREFS_KEY_LANG, value: LanguageType.ARABIC.getValue());
      Phoenix.rebirth(context);
    }
  }
